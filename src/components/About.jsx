    ...
    return (
        <>
            <div className="container">
                <h1 className='text-center ' style={{ margin: '10rem' }}>About Smart SheetAnalyzer</h1>
